...
export const CLOUD_ROUTES = Object.freeze({
  ...
  vercel: Object.freeze({ authority: "EVAVO-STUDIO/evavo-development-studio", preferredTransport: "cloudflare-provider-mcp", preferredEndpoint: "vercel-provider-cloud-mcp", fallback: "EVAVO-STUDIO/evavo-development-studio:local-vercel-control-mcp", state: "configured-route-live-health-required", writeState: "disabled-until-live-provider-health-and-provider-readback-proven", configuredEndpointIsAvailabilityEvidence: false }),
...
export function cloudFabricStatus() {
  return Object.freeze({
    ...
    policy: Object.freeze({
      ...
      configuredCloudEndpointIsAvailabilityEvidence: false,
      liveHealthRequiredForCloudRouteSelection: true,
    }),

...
const ROUTES = Object.freeze({
  ...
  cloudDrive: "provider-native:Google_Drive",
  driveBrowse: "provider-native:Google_Drive",
  driveSearch: "provider-native:Google_Drive",
  driveMove: "provider-native:Google_Drive",
  driveRename: "provider-native:Google_Drive",
  driveUpload: "provider-native:Google_Drive",
  driveDelete: "provider-native:Google_Drive",
  driveSpaceManagement: "provider-native:Google_Drive",
